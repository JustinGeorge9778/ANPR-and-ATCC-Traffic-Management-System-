...
class AccidentDetectionSystem:
    def __init__(self, model_path, conf_threshold=0.4, enable_gui=True):
        ...
        try:
            # Load YOLOv8 model
            self.model = YOLO(r"C:\Users\jg184\Downloads\accident_best (1).pt")
    ...
    def detect_accident(video_paths):
        ...
        MODEL_PATH = r"C:\Users\jg184\Downloads\accident_best (1).pt"
...
if __name__ == "__main__":
    AccidentDetectionSystem.detect_accident([
        r"C:\Users\jg184\Downloads\accident.mp4",
        r"C:\Users\jg184\Downloads\triple riding 2.mp4"
