...
# Load YOLOv8 model
model = YOLO(r"C:\Users\jg184\Downloads\triple riding (1).pt")  # 'yolov8s.pt' is the small version; replace with other versions if needed
...
if __name__ == "__main__":
    # Input video path
    video_path = r"C:\Users\jg184\OneDrive\Desktop\infosys_intern_vscode_files\uploads\triple_riding.mp4"
